...
-- CreateEnum
CREATE TYPE "WorkspaceInvitationStatus" AS ENUM ('INVITED', 'ACTIVE', 'SUSPENDED');
...
-- CreateEnum
CREATE TYPE "ProjectVisibility" AS ENUM ('PUBLIC_TO_WORKSPACE', 'PRIVATE');
...
-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('WORKSPACE_CREATED', 'MEMBER_INVITED', 'MEMBER_ROLE_CHANGED', 'PROJECT_CREATED', 'PROJECT_UPDATED', 'TASK_CREATED', 'TASK_UPDATED', 'STATUS_CHANGED', 'PRIORITY_CHANGED', 'ASSIGNEE_CHANGED', 'DUE_DATE_CHANGED', 'COMMENT_ADDED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_STATUS_CHANGED', 'MENTION', 'COMMENT_REPLY', 'PROJECT_INVITE', 'SYSTEM');
...
CREATE TABLE "Project" (
    ...
    "visibility" "ProjectVisibility" NOT NULL DEFAULT 'PUBLIC_TO_WORKSPACE',
    "color" TEXT,
